...
function generateQuestionInput(question, index, surveyColor = "#253074") {
  // Create the bullet point and question container
  const questionWithBullet = `
      ...
      return `
        <div class="survey-question">
          ...
          <div class="form__group_one">
            <input type="text" class="form__group_oneform__field" name="q${index}" placeholder="Enter your response" required autocomplete="off">
            <label class="form__group_oneform__label">Enter your response</label>
          </div>
        </div>
      `
    case "radio":
            ...
            ${question.options
              ...
              <div class="radio-button">
                <input type="radio" 
                  ...
                  required
                >
                <label for="radio${index}_${option}" class="radio-button__label">
                  ${option}
                  <span class="radio-button__custom" style="border-color: ${surveyColor}"></span>
                </label>
              </div>
            `,
              )
        ...
        <div class="survey-question">
          ...
          <div class="checkbox-buttons-container">
            ${question.options
              ...
              <div class="radio-button">
                <input type="checkbox" 
                  id="checkbox${index}_${option}" 
                  name="q${index}" 
                  value="${option}" 
                  class="radio-button__input"
                >
                <label for="checkbox${index}_${option}" class="radio-button__label">
                  ${option}
                  <span class="radio-button__custom" style="border-color: ${surveyColor}"></span>
                </label>
              </div>
          ...
          <div class="star-rating-container">
            <div class="star-rating-row">
              ${[1, 2, 3, 4, 5]
                .map(
                  (star) => `
                <label class="star-rating-option" style="color: ${surveyColor}">
                  <input type="radio" name="q${index}" value="${star}" required style="display: none;">
                  ★
                </label>
              `,
                )
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Update the signup form HTML to include the employee ID field and tenure dropdown
